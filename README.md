...
Check out this useful [overview of the BUILD architecture](https://github.wdf.sap.corp/UXD-BUILD-OPENSOURCE/BUILD/blob/master/docs/Architecture/BUILD%2Barchitecture%2Bpresentation%2BV2.pptx).
...
3. Build and run:
   ...
   ```
_If you're having a problem installing, you can create a bug or ask a question using the [BUILD Issue Tracker](https://github.wdf.sap.corp/UXD-BUILD-OPENSOURCE/BUILD/issues)._ For more information, see our [Contribution Guidelines](https://github.wdf.sap.corp/UXD-BUILD-OPENSOURCE/BUILD/wiki/Contribution-Guidelines).
...
For more information, see our [Contribution Guidelines](https://github.wdf.sap.corp/UXD-BUILD-OPENSOURCE/BUILD/wiki/Contribution-Guidelines).

## Copyright and Licenses

+ [Apache License](https://github.wdf.sap.corp/UXD-BUILD-OPENSOURCE/BUILD/wiki/License)
+ [Individual Contribution License Agreement](https://github.wdf.sap.corp/UXD-BUILD-OPENSOURCE/BUILD/blob/master/docs/SAP%20License%20Agreements/SAP%2BIndividual%2BContributor%2BLicense%2BAgreement.pdf) 
+ [Corporate Contributor License Agreement](https://github.wdf.sap.corp/UXD-BUILD-OPENSOURCE/BUILD/blob/master/docs/SAP%20License%20Agreements/SAP%2BCorporate%2BContributor%2BLicense%2BAgreement.pdf) 

## Legal Notices

[View the legal notice about fonts used in Build](https://github.wdf.sap.corp/UXD-BUILD-OPENSOURCE/BUILD/wiki/Legal-Notice-About-Fonts).
